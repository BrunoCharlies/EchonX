...
export function AudiopostDashboardMobile({
  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col overflow-y-auto overflow-x-hidden overscroll-y-auto touch-pan-y bg-[#050a12] lg:hidden [-webkit-overflow-scrolling:touch]">
      <div
